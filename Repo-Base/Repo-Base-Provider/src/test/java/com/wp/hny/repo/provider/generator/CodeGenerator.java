package com.wp.hny.repo.provider.generator;
import java.io.File;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://47.106.206.152:3306/hny";
    ...
    private static final String AUTHOR = "wenpeng";//@author
    private static final String DATE = new SimpleDateFormat("yyyy年MM月dd日 HH:mm:ss").format(new Date());//@date
